package com.github.summerframework.base.data;
...
import com.github.summerframework.base.model.DomainEntity;
...
public class BaseJpaRepositoryImp<T, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements BaseJpaRepository<T,ID> {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(BaseJpaRepositoryImp.class);
